...
<meta property="og:title" content="Samuel Joseph Decorator | Painter and Decorator in Bath">
<meta property="og:description" content="Trusted local painter and decorator in Bath. Quality craftsmanship and free quotes.">
<meta property="og:image" content="https://samueljoseph.uk/images/logo-01.png">
<meta property="og:url" content="https://samueljoseph.uk">
<meta property="og:type" content="website">

<link rel="canonical" href="https://samueljoseph.uk/">
...
<link rel="preload" as="image" href="<?php echo get_template_directory_uri(); ?>/img/logo-transbg.svg">
	...
	<div id="sticky-header">
		<div class="inner-width-constraint">
			...
			<div id="header-el-wrap">
				...
				<img id="logo-header"  src="<?php echo get_template_directory_uri(); ?>/img/logo-transbg.svg" alt="Samuel Joseph Decorator Bath">


				<div id="header-text">
      
            <h1  class="header-title-new">
              SAMUEL&nbsp;JOSEPH
              <span class="header-subtitle-new">DECORATOR</span>
          </h1>
				</div>
			</div>
			...
			<div id="header-el-2-contact">
				...
				<a href="#" class="callLink header-link">
        			<span class="mobile-label mobile-header-display">Call</span>
       				<span class="desktop-label desktop-header-display"><!--JS--></span>
      			</a>
